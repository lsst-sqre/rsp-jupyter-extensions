...
class RSPClient:
    ...
    async def get_datasets(self) -> list[str]:
        return await self.discovery_client.datasets()
    ...
    async def get_logout_url(self) -> str | None:
        return await self.discovery_client.url_for_ui("logout")

    async def get_landing_page_url(self) -> str | None:
        return await self.discovery_client.url_for_ui("squareone")

    async def get_times_square_url(self) -> str | None:
        return await self.discovery_client.url_for_internal("times-square")
